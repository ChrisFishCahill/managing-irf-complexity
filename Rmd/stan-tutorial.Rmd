...
Stan does all this magic for you, which is pretty dope. 

See this link for a visualization of how Stan is simulating the posterior--we won't dive into the specfics unless people want to, but I think this is cool: 
