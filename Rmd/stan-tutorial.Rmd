...
Your biologist friends tell you there is some industrial development planned for km 18.7.  They need to determine what the expected density of critters in that location given these data so that they can evaluate alternative management options. However, point count surveys only occurred at kms 15 and 20.  Can you help them? 
