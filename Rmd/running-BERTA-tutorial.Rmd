...
Now read in the stocking data, which was used for plotting and not fitted.  Note these stocking records go from 1980-2018, and are number of Walleye stocked per hectare: 
```{r}
