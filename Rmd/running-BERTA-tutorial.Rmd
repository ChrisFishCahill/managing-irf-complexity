...
- calculate the proportion of fish with age structure estimates in that survey in the `p_aged` slot
- put the catch at each age from 0 to 25 in columns labelled '0', '1', ..., '25'
