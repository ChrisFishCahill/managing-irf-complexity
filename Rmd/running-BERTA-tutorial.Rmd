...
Here's how we can use all of the tricks from above to greatly speed up our computations for the BERTA assessment models.  First we declare a few variables for the Stan model: 
...
Then we call `plan()`, `get_fit()`, and `future_pwalk()`: 
