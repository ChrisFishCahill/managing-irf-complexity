...
urlcolor: blue
---
# TODO from 4 Jan 2022 conversation 
- diagnostics--general talk
- add new data exercise 
- run fit without fancy wrapper 
...
After running these lines, a browser opens and you can explore the performance of chains and a variety of other Bayesian MCMC model diagnostics. 
