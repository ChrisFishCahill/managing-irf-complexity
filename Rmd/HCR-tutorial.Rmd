...
If you are a visual learner, you might have an easier time with the following simple hypothetical depiction of fixed escapement MAY polcies vs. a HARA policy.  
...
vB <- seq(from=0.1, to =100, length.out = 100) #  x axis - biomass of critter vulnerable to fishing
...
Next we can plot exploitation rate as a function of stock size for these simple examples using this code: 
...
In these examples, there is a lower limit reference point $b_{lrp}$ and a slope at which you increase harvest as stock size increases ($c_{slope}$ in the code). Think about these two plots a bit--it is important to wrap your head around what this is showing you. 
