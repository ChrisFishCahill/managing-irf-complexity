...
That's exciting, albeit melodramatic.  So we'll proceed on with some results given these simple linear harvest control rule simulations.

## Results given provisional objectives and Beverton-Holt $\phi$ = 6 Bayesian model fits

In an effort to end this sufferfest, I'm going to try and wrap up some of the main findings from these model runs.  I told you a long time ago that the general patterns between the MAY and HARA objectives from lots of theoretical work showed that when MAY was maximized, you typically had a non-zero fixed escapement $b_{lrp}$ point and a $c_{slope}$ value near one. 

Because we actually simulated across an entire policy space, we can visualize our solutions using isopleths.

![Approximation in policy space results for maximum average yield (MAY) objective. Black dot represents the best result given the MAY objective and the simple linear policies. This isopleth was created assuming discard mortality = 0.3, assessment interval = 1 year, and sdsurvey = 0.4. \label{fig1}](C:/Users/Chris Cahill/Documents/GitHub/managing-irf-complexity/plots/hcr_wts.jpeg)


![Approximation in policy space results for maximum average yield (MAY) objective. Black dot represents the best result given the MAY objective and the simple linear policies. This isopleth was created assuming discard mortality = 0.3, assessment interval = 1 year, and sdsurvey = 0.4. \label{fig1}](C:/Users/Chris Cahill/Documents/GitHub/managing-irf-complexity/plots/yield_isos_ass_int_1_dmort_0.3_sd_0.4.jpeg)

And we can compare this with our HARA utility simulation results:

![Isopleths for dmort = 0.4, ass int =1, sdsurvey = 0.4. \label{fig1}](C:/Users/Chris Cahill/Documents/GitHub/managing-irf-complexity/plots/hara_isos_ass_int_1_dmort_0.3_sd_0.4.jpeg)

![Isopleths for dmort = 0.4, ass int =1, sdsurvey = 0.4. \label{fig1}](C:/Users/Chris Cahill/Documents/GitHub/managing-irf-complexity/plots/yield_hcr_sensitivity_sd_0.4_dmort_0.3.jpeg)

![Isopleths for dmort = 0.4, ass int =1, sdsurvey = 0.4. \label{fig1}](C:/Users/Chris Cahill/Documents/GitHub/managing-irf-complexity/plots/hara_hcr_sensitivity_sd_0.4_dmort_0.3.jpeg)


We can play other games, too, like whether performance at achieving an objective degrades with increasing survey interval: 

![Isopleths for dmort = 0.4, ass int =1, sdsurvey = 0.4. \label{fig1}](C:/Users/Chris Cahill/Documents/GitHub/managing-irf-complexity/plots/performance_v_assint_sd_0.4_dmort_0.3.jpeg)

And we can do the same thing for HARA utility vs. assessment interval: 

![Isopleths for dmort = 0.4, ass int =1, sdsurvey = 0.4. \label{fig1}](C:/Users/Chris Cahill/Documents/GitHub/managing-irf-complexity/plots/performance_hara_v_assint_sd_0.4_dmort_0.3.jpeg)
