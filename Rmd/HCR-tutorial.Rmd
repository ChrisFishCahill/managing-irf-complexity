...
We then "just" need to run all those calculations for all years t, all $c_{slope}$ and $b_{lrp}$ values, and all random draws from the posterior. So we close off all the loops of misery and move on with our lives.
