...
When we make isopleths of the simulation output, we can see that on average the best $b_{lrp}$ vlaues are greater than zero and the $c_{slope}$ values are near one when our objective was to maximize MAY (Fig. 3). Calling lake is a bit different, but in general the theory appears to hold: 

![Approximation in policy space results for maximum average yield (MAY) objective. Black dot represents the best linear policy given the MAY objective. This isopleth was created using an assessment interval of 1 year, a $\sigma_{survey}$ = 0.4, and a $U_d$ = 0.3. \label{fig1}](C:/Users/Chris Cahill/Documents/GitHub/managing-irf-complexity/plots/yield_isos_ass_int_1_dmort_0.3_sd_0.4.jpeg)
...
![Best linear harvest control rules for MAY objective, where line color indicates the interval at which the fishery is assessed.  This plot was created using a $\sigma_{survey}$ = 0.4, and a $U_d$ = 0.3. \label{fig1}](C:/Users/Chris Cahill/Documents/GitHub/managing-irf-complexity/plots/yield_hcr_sensitivity_sd_0.4_dmort_0.3.jpeg)
...
Cahill et al. 2021. Unveiling the recovery dynamics of walleye after the invisible collpase. Canadian Journal of Fisheries and Aquatic Sciences. 
