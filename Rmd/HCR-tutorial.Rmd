...
I am using the tidybayes package to manage Bayesian model output.  There are many other ways to do this, but I like this way, and so now you have to learn it. Let's assume for now that `n_draws = 1`.  The next chunk of code is: 
...
and we then put the stuff we need into the `post` tibble for use later on.
