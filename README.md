...
### Data
This repository contains data for six Alberta Walleye lakes courtesy of Alberta Environment and Parks.  See [this link](https://www.alberta.ca/assets/documents/ep-fwmis-data-sharing-agreement.pdf) for information on the Fish and Wildlife Management Information System (FWMIS) from the Alberta government. Data for six lakes in Cahill et al. 2021 (Baptiste Lake, Calling Lake, Lac Ste. Anne, Lake Newell, Moose Lake, and Pigeon Lake, years 2000-2018) were shared courtesy of the Alberta government to complete this contract.  We are sharing those data with you so you can run the assessments and harvest control rule simulations on your own machine.
