...
### Data
This repository contains data for six Alberta Walleye lakes.  See [this link](https://www.alberta.ca/assets/documents/ep-fwmis-data-sharing-agreement.pdf) for the data sharing agreement for the Fish and Wildlife Management Information System (FWMIS) from the Alberta government. Data for six lakes in Cahill et al. 2021 (Baptiste Lake, Calling Lake, Lac Ste. Anne, Lake Newell, Moose Lake, and Pigeon Lake, years 2000-2018) were shared courtesy of the Alberta government.  We used these data to complete develop a framework to evaluate harvest control rules for Walleye fisheries in Alberta.  After discussions with the Alberta government, we have decided to share data, code, and tutorials with others so folks can run the assessment models and harvest control rule simulations scripts in this repository on their own.
